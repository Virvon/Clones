    ...
    public class GameStateMachine : IGameStateMachine
    {
        ...
        public GameStateMachine(SceneLoader sceneLoader, LoadingPanel loadingPanel, AudioMixerGroup audioMixer, AllServices services, ICoroutineRunner coroutineRunner)
        {
            _states = new Dictionary<Type, IExitableState>()
            {
                ...
                [typeof(MainMenuLoopState)] = new MainMenuLoopState(services.Single<IMainMenuFactory>(), services.Single<IMainMenuStaticDataService>(), services.Single<ICharacterFactory>()),
