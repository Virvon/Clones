    ...
    public class GameStateMachine : IGameStateMachine
    {
        ...
        public GameStateMachine(SceneLoader sceneLoader, LoadingPanel loadingPanel, AllServices services, ICoroutineRunner coroutineRunner)
        {
            _states = new Dictionary<Type, IExitableState>()
            {
                ...
                [typeof(EducationState)] = new EducationState(services.Single<IGameFacotry>(), services.Single<IPartsFactory>(), services.Single<IGameStaticDataService>(), services.Single<IPersistentProgressService>()),
